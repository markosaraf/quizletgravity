...
export const STRINGS = {
  ...
  directions: {
    ...
    body: [
      ...
      "If you miss one, you'll have to copy the correct answer to keep playing. Miss the same term twice and the game is over.",
  ...
  alerts: {
    asteroid_incoming: 'Warning: asteroid incoming!',
  ...
  game_over: {
    ...
    high_score_label: 'New personal best!',
  ...
  desktop_blocker:
    'Your window is too small to play Gravity. Enlarge your browser window to continue.',
